...
public class PartitionProcessor : IDisposable, IPartitionProcessor {
    ...
    /// <summary>
    ///     <see cref="PartitionProcessor" /> processors messages placed on its queue. It is assigned to a particular
    ...
    /// </param>
    public PartitionProcessor(ILogger logger,
